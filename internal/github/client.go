// Package github provides GitHub API integration for maestro.
package github
...
// Interface defines the interface for GitHub operations.
...
// Tools handles interactions with GitHub API.
type Tools struct {
	client            *github.Client
	owner             string
	repo              string
...
// PreviewOptions configures how review previews are displayed.
...
// DiffPosition represents a position in a diff.
...
func (g *Tools) GetRepositoryInfo(ctx context.Context) types.RepositoryInfo {
...
func (g *Tools) GetAuthenticatedUser(ctx context.Context) string {
	return g.authenticatedUser
}

// GetPullRequestChanges retrieves the changes from a pull request.
func (g *Tools) GetPullRequestChanges(ctx context.Context, prNumber int) (*types.PRChanges, error) {
	...
	changes := &types.PRChanges{
		Files: make([]types.PRFileChange, 0, len(files)),
	}
...
func (g *Tools) CreateReviewComments(ctx context.Context, prNumber int, comments []types.PRReviewComment) error {
	...
	hunksByFile := make(map[string][]types.ChangeHunk)
	...
	for _, comment := range comments {
		...
		var targetHunk *types.ChangeHunk
		for i := range hunks {
...
func (g *Tools) GetFileContent(ctx context.Context, filePath string) (string, error) {
...
func (g *Tools) GetLatestCommitSHA(ctx context.Context, branch string) (string, error) {
...
func (g *Tools) PreviewReview(ctx context.Context, console types.ConsoleInterface, prNumber int, comments []types.PRReviewComment, metric types.MetricsCollector) (bool, error) {
	...
	for filePath, fileComments := range commentsByFile {
		...
		var fileChange *types.PRFileChange
...
func (g *Tools) GetPullRequest(ctx context.Context, owner, repo string, prNumber int) (*github.PullRequest, *github.Response, error) {
	return g.client.PullRequests.Get(ctx, owner, repo, prNumber)
}

func (g *Tools) GetRepository(ctx context.Context, owner, repo string) (*github.Repository, *github.Response, error) {
	return g.client.Repositories.Get(ctx, owner, repo)
}

func (g *Tools) GetRepositoryContents(ctx context.Context, owner, repo, path string, opts *github.RepositoryContentGetOptions) (*github.RepositoryContent, []*github.RepositoryContent, *github.Response, error) {
	return g.client.Repositories.GetContents(ctx, owner, repo, path, opts)
}

func (g *Tools) CompareCommits(ctx context.Context, owner, repo, base, head string, opts *github.ListOptions) (*github.CommitsComparison, *github.Response, error) {
	return g.client.Repositories.CompareCommits(ctx, owner, repo, base, head, opts)
}

func (g *Tools) ListLanguages(ctx context.Context, owner, repo string) (map[string]int, *github.Response, error) {
...
func (g *Tools) getPreviousContent(ctx context.Context, filepath string, prNumber int) (string, error) {
...
// ShouldSkipFile determines if a file should be skipped for review.
...
func formatCommentBody(comment types.PRReviewComment) string {
...
// ParseHunks parses diff hunks from a patch.
...
func (g *Tools) ListPullRequestReviews(ctx context.Context, owner, repo string, prNumber int, opts *github.ListOptions) ([]*github.PullRequestReview, *github.Response, error) {
...
func (g *Tools) CreatePullRequestReviewComment(ctx context.Context, owner, repo string, prNumber int, comment *github.PullRequestReviewRequest) (*github.PullRequestReview, *github.Response, error) {
